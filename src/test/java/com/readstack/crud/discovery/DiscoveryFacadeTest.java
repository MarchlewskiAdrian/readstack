...
import com.readstack.crud.category.CategoryLookupImpl;
...
class DiscoveryFacadeTest {
    ...
    private final CategoryLookup categoryLookup = mock(CategoryLookupImpl.class);
    private final DiscoverySpecificationsBuilder builder = new DiscoverySpecificationsBuilder();
    private final ResourceBusinessValidator resourceBusinessValidator = new ResourceBusinessValidator();
    ...
    private DiscoveryFacade createDiscoveryFacade(
        ...
        DiscoveryDataValidator discoveryValidator = new DiscoveryDataValidator(discoveryRepository);
        DiscoveryFetcher discoveryFetcher = new DiscoveryFetcher(discoveryRepository, builder);
        DiscoveryAdder discoveryAdder = new DiscoveryAdder(discoveryRepository, discoveryValidator, lookup);
        DiscoveryUpdater discoveryUpdater = new DiscoveryUpdater(discoveryFetcher, discoveryRepository, discoveryValidator, resourceBusinessValidator, lookup);
        DiscoveryDeleter discoveryDeleter = new DiscoveryDeleter(discoveryRepository, resourceBusinessValidator);
    ...
    void should_return_all_discoveries_when_discoveries_exist() {
        ...
        when(categoryLookup.getEntityById(category.getId())).thenReturn(category);
    ...
    void should_update_discovery_by_id_when_discovery_exists() {
        ...
        DiscoveryGetDto updatedDiscovery = discoveryFacade.updateById(addedDiscovery.id(), body, null);
    ...
    void should_delete_discovery_by_id() {
        ...
        //when
        discoveryFacade.deleteById(addedDiscovery.id(), null);
        DiscoveryFilter filter = new DiscoveryFilter(null, null, null, null, null, null);
