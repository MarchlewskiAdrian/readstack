...
public class InMemoryDiscoveryRepository implements DiscoveryRepository {
    ...
    @Override
    public Optional<Discovery> findOne(Specification<Discovery> spec) {
        return Optional.empty();
    }

    @Override
    public List<Discovery> findAll(@Nullable Specification<Discovery> spec) {
        return List.of();
    }

    @Override
    public Page<Discovery> findAll(Specification<Discovery> spec, Pageable pageable) {
        List<Discovery> all = db.values()
                .stream()
                .toList();
        return new PageImpl<>(
    ...
    @Override
    public Page<Discovery> findAll(@Nullable Specification<Discovery> spec, @Nullable Specification<Discovery> countSpec, Pageable pageable) {
        return null;
    }

    @Override
    public List<Discovery> findAll(@Nullable Specification<Discovery> spec, Sort sort) {
        return List.of();
    }

    @Override
    public long count(@Nullable Specification<Discovery> spec) {
        return 0;
    }

    @Override
    public boolean exists(Specification<Discovery> spec) {
        return false;
    }

    @Override
    public long delete(@Nullable Specification<Discovery> spec) {
        return 0;
    }

    @Override
    public <S extends Discovery, R> R findBy(Specification<Discovery> spec, Function<? super SpecificationFluentQuery<S>, R> queryFunction) {
        return null;
    }
    ...
    @Override
    public boolean existsByAudit_creator(Long creator) {
        return false;
    }
